...
export const categories: MockCategory[] = [
  ...
  },
  {
    ...
    slug: "gift-boxes",
    name: "جعبه‌های هدیه",
    description: "هدیه‌ای لوکس برای عزیزانتان، در بسته‌بندی نفیس و نفیس",
    productCount: 6,
  },
];
...
export const products: MockProduct[] = [
  {
    ...
    categoryName: "آجیل",
    images: [
      "/images/products/pistachio-akbari-1.jpg",
      "/images/products/pistachio-akbari-2.jpg",
    ],
  ...
  },
  {
    ...
    categoryName: "آجیل",
    images: [
      "/images/products/almond-mamra-1.jpg",
      "/images/products/almond-mamra-2.jpg",
    ],
  ...
  },
  {
    ...
    categoryName: "آجیل",
    images: [
      "/images/products/walnut-kashan-1.jpg",
      "/images/products/walnut-kashan-2.jpg",
    ],
    tags: ["کاشان", "مغز سفید"],
  ...
  },
  {
    ...
    categoryName: "خشکبار",
    images: [
      "/images/products/dried-figs-1.jpg",
      "/images/products/dried-figs-2.jpg",
    ],
  ...
  },
  {
    ...
    categoryName: "خشکبار",
    images: [
      "/images/products/dried-apricot-1.jpg",
      "/images/products/dried-apricot-2.jpg",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/products/choc-almond-1.jpg",
      "/images/products/choc-almond-2.jpg",
    ],
  ...
  },
  {
    ...
    longDescription:
      "جعبه هدیه سلطنتی، تجمیعی از بهترین‌های ShahMaghz: پسته اکبری ممتاز، بادام مامرا، گردو کاشان، انجیر خشک استهبان و زردآلو تبریز، در جعبه چوبی نفیس با رویه مخمل و مهر مومی طلایی. هر جعبه با دست آماده و پلمپ می‌شود. هدیه‌ای بی‌نقص برای مناسبت‌های ویژه، شب یلدا و عید نوروز.",
    categoryId: "cat-gift-boxes",
    categorySlug: "gift-boxes",
    categoryName: "جعبه‌های هدیه",
    images: [
      "/images/products/gift-box-royal-1.jpg",
      "/images/products/gift-box-royal-2.jpg",
    ],
